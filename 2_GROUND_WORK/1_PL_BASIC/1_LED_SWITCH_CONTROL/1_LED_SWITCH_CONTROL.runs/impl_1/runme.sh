...
HD_PWD='C:/repo/FPGA/SoC_301/2_GROUND_WORK/1_PL_BASIC/1_LED_SWITCH_CONTROL/1_LED_SWITCH_CONTROL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_switch_control.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_switch_control.tcl -notrace
