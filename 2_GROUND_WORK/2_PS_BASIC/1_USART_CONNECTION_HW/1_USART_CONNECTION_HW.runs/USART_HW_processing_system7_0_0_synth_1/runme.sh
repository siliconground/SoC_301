...
HD_PWD='C:/repo/SOC/SoC_301/2_GROUND_WORK/2_PS_BASIC/1_USART_CONNECTION_HW/1_USART_CONNECTION_HW.runs/USART_HW_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log USART_HW_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source USART_HW_processing_system7_0_0.tcl
